...
/*
 * @brief Frees the previously allocated rectangle.
 * @param r		Pointer to pointer to rectangle to be deallocated.
 * @return		void.
 */
...
/*
 * @brief Copies the source rectangle to the destination one.
 ...
 * destination one.
 * @param src	First rectangle.
 * @param dst	Second rectangle.
 * @return		stm32ipl_err_Ok on success, error otherwise.
 */
...
/*
 * @brief Finds the union of two rectangles and saves it into the destination one.
 * @param src	First rectangle.
 * @param dst	Second rectangle.
 * @return		stm32ipl_err_Ok on success, error otherwise.
 */
 ...
 * @param dst	Destination ROI (valid only when this function returns true).
 ...
 * @param r			Rectangle.
 * @param points	Four points vector.
 * @return			stm32ipl_err_Ok on success, error otherwise
 */
 ...
 * @param rects	Pointer to pointer to an array of rectangle_t.
 * @return		stm32ipl_err_Ok on success, error otherwise
 */
